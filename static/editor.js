...
const kernelTheme = EditorView.theme({
  ...
  "&.cm-focused > .cm-scroller > .cm-selectionLayer .cm-selectionBackground": { backgroundColor: "#2f6f8f" },
  ".cm-selectionBackground": { backgroundColor: "#2f6f8f" },
  ".cm-content ::selection": { color: "#ffffff", backgroundColor: "#2f6f8f" },
  ".cm-selectionMatch": { backgroundColor: "rgba(216, 255, 62, .18)", outline: "1px solid rgba(216, 255, 62, .32)" },
